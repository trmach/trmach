; Hacked by [REDACTED] aka Alex
; and once again by trmach
      processor 6502
...
Music: ;Music is here to be in the byte range of a branch.
    ;LDA    #$0F                                                                                           ;2
